...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cards item = new cards("ID", "Name", "default");
        rowItems.add(item);
...
//            }
    ...
    public void checkUserSex(){
        ...
        maleDb.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                System.out.println(dataSnapshot.getKey()+" "+user.getUid());
    ...
    public void getOppositeSexUsers(){
        ...
        oppositeSexDb.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                System.out.println(currentUId+" "+dataSnapshot.child("connections").child("nope").hasChild(currentUId)+ " "+dataSnapshot.child("connections").child("yeps").hasChild(currentUId));
                if (dataSnapshot.exists() && !dataSnapshot.child("connections").child("nope").hasChild(currentUId) && !dataSnapshot.child("connections").child("yeps").hasChild(currentUId)){
                    ...
                    cards item1 = new cards(dataSnapshot.getKey(), dataSnapshot.child("name").getValue().toString(), profileImageUrl);
                    rowItems.add(item1);
                    arrayAdapter.notifyDataSetChanged();
                }
            }
  ...
  /**/  @Override
    protected void onResume() {
        super.onResume();
        cards item = new cards("ID", "Resume", "default");
        rowItems.add(item);
